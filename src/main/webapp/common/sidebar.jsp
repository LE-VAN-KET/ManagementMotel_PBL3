<nav class="fixed-top align-top" id="sidebar-wrapper" role="navigation">
    <div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="navbar-nav align-self-stretch">
            <li class="">
                <a class="nav-link text-left active" role="button" href="/admin/home" aria-haspopup="true" aria-expanded="false">
                    <i class="fas fa-tachometer-alt"></i><span class="px-2">Dashboard</span>
                </a>
            </li>
