                ...
                <nav class="navbar navbar-expand-md navbar-light p-0">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <c:if test="${'LANDLORD'.equals(ACCOUNTMODEL.user.roleMole.roleName)}">
                            <a type="button" href="/post" class="animated-dang-tin btn btn-white ml-3 d-sm-inline-block
                            d-inline-block"
                               style="color: #111;">
                                <span></span>
                                <span></span>
                        ...
                        <c:if test="${ACCOUNTMODEL != null}">
                            <a type="button" class="message ml-0 ml-md-4 btn btn-light d-inline-block text-primary
                            d-flex align-items-center d-sm-inline-block"
                               href="/message" data-toggle="tooltip" data-placement="bottom" title="message">
                                <i class="far fa-comment-dots"></i>
                            </a>
                            <div class="dropdown dropdown-slide dropdown-hover ml-0 ml-md-4 d-inline-block
                             d-sm-inline-block">
                                <a type="button" class="dropdown-toggle setting btn btn-light d-flex align-items-center"
